...
class CausalOptimalStopping:
    ...
    def __init__(self, 
        ...
        print(f"Initialized Causal Optimal Stopping Problem (DAMPENED VERSION)")
...
if __name__ == "__main__":
    ...
    print("DAMPENED SHOCKS VERSION (Colleague's Formula)")
    print("="*80)
    ...
    # Initialize the model with DAMPENED formula
